          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Completion rate across courses</p>
              </div>
            </div>
            <ChartContainer
              config={radarConfig}
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Quiz performance across chapters</p>
                </div>
              </div>
            ...
            {chapterMarksData.length > 0 ? (
              ...
              <div className="h-[300px] flex flex-col items-center justify-center text-slate-500">
                ...
                <p className="text-sm text-slate-400">Student needs to complete quizzes to see marks!</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-xl p-6 mb-8 shadow-lg">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Student&apos;s Next Adventure</h2>
